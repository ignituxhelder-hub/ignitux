...
Au 20/09/2026 : **740 tests unitaires backend**, **251 tests de bout en bout**, **216 tests
frontend**, lint et type-check propres des deux côtés. **146 routes HTTP**, **46 tables**,
**15 pages**.
